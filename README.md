...
### Eva:
 ...
 - Binary Grading:
     ...
     5. Highlight WOW or insight in doing this project. 
      ...
      6. full route in app.py file [here](https://github.com/evagravin/p4-kangaroos/blob/main/templates/minilabs/eva-minilab.html), backend py file [here](https://github.com/evagravin/p4-kangaroos/blob/main/TheSmack/minilabs/eva_minilab.py), html file [here]()
