...
#def api_tester():
    ...
    #METHOD = 1
    #tests = [
        #['/create/Wilma Flinstone/wilma@bedrock.org/123wifli/0001112222', "post"], #put in the information of our posts
       # ['/read/', "get"], # have all create, read, update?
    ...
    #api_tester()
    #print_tester()
#need to create these in models file
